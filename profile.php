 ...
 include("session.php");
    ...
    if(isset($_GET['authfail'])) {
        echo '<div class="btn alert-danger alert-dismissable fade in" data-auto-dismiss="2000" role="alert" style="width: 100%; z-index: 1; position: absolute; opacity: .95; top: 1em;">
            <span class="glyphicon glyphicon-warning"></span>
            <a href="profile.php" class="close"  aria-label="close">&times;</a>
            <p><b>Oops!</b>, Sorry, you do not have permissions.</p>
	    </div>';
    }
...
<head>
    ...
    <title>My Profile | Runtech&reg;</title>
...
<body>
	...
	<div id="container">
        ...
        <button id="menu-btn" class="menu-btn" onclick="viewmenu(this.value);" style="background-color: darkorange; color: black; padding: 2px;"><span class="glyphicon glyphicon-menu-hamburger"></span> Menu</button>
        ...
        <div id="buttons" class="alert">
            ...
            <button class="btn btn-warning block" onclick="document.location.href='manage-enquiries.php'">Manage<br>Enquiries</button>
            <button class="btn btn-warning block" onclick="document.location.href='manage-files.php'">Manage<br>Content</button>
            ...
            <button class="btn btn-warning block" onclick="document.location.href='select_subject.php'">RunTech<br> Resources</button>
        ...
        <div id="main" class="row">
            <div class="user-info col-md-4">
                <h3 style="text-align: center; background-color:darkorange; border-radius: 5px; padding: 2px; color: black;">Welcome To Your RunTech Client Profile</h3>
                <?php
                    echo
                    '<div>' .
        ...
        <div class="modal-footer" style="font-size: x-large; clear: both; position:relative; bottom: 0; padding: 0 10px;">
            <h5>RunTech&reg; 2019, All rights reserved</h5>
        </div>
    </div>
